...
const TitleDetail = () => {
  ...
  const [vehicleData, setVehicleData] = React.useState<VehicleType>({} as VehicleType);
              ...
              <div className="p-4 w-[380px] rounded-xl bg-secondary-20 relative shadow-dark">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex flex-col gap-2">
                    <p className={`${completedHolds === numHolds ? `bg-secondary-100` : `bg-accent1-80`} w-[84px] h-[28px] flex justify-center items-center text-sm text-primary-0 font-bold  px-1 rounded-lg `}>
                ...
                <div>
                  ...
                  <p className="text-xl text-secondary-90">
                    {vehicleData.city}.Sacramento/California
                  </p>
                </div>
                {/* serial */}
