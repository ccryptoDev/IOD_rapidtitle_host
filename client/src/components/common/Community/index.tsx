...
export default function Community() {
  ...
  const [selectedRoomTitle, setSelectedRoomTitle] = React.useState<TitleType>({} as TitleType);
  ...
  const changeRoom = async (room_id: any, room_img: any, room_name: any, roomTitle: TitleType) => {
    console.log('chatroom ID: ', room_id);
    console.log('chatroom Name: ', room_name);
                  ...
                  {chat_room_id !== '' ? (
                    <>
                      ...
                      <div className="flex items-center gap-2">
                        <div className={`py-1 px-3 ${selectedRoomTitle.status ? `bg-secondary-100` : `bg-accent1-100`} text-sm text-primary-0 font-bold rounded-lg`}>
                          {selectedRoomTitle.completedHolds}/{selectedRoomTitle.numHolds} Holds
                        </div>
                        <div className={`py-2 px-3 ${selectedRoomTitle.status ? `bg-secondary-100` : `bg-accent1-70`} text-sm text-primary-0 font-bold rounded-lg`}>
                          {selectedRoomTitle.status ? `Completed` : `Pending`}
                        </div>
